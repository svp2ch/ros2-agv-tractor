...
class DecisionNode(Node):
    ...
    def _cb_scan(self, msg: LaserScan):
        ...
        # отражением от собственного корпуса / артефактом на границе min_range
        # лидара (одиночные засветки ровно на 0.4м) и игнорируется.
        # 0.5 > min_range лидара (0.4) — отсекает паразитные засветки на границе.
        self_clip_dist = 0.5
